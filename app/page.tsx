  ...
  return (
    <>
      ...
      <div className="hidden md:flex items-center justify-center h-dvh bg-neutral-950 p-2 overflow-hidden">
        ...
        >
          {/* Phone bezel */}
          <div className="relative h-full w-full rounded-[3rem] border-[6px] border-neutral-700 shadow-[0_0_80px_rgba(37,99,235,0.08),0_0_0_1px_rgba(255,255,255,0.06)] bg-background overflow-hidden">
